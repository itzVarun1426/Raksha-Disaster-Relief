  ...
  return (
    ...
    <div className="helpline-container">
      ...
      <div className="emergency-note">
        <p>In case of emergency, dial the appropriate number immediately</p>
        <p>All emergency services are available 24/7</p>
        <p>Keep these numbers handy for quick access during emergencies</p>
      </div>
    </div></div>
  );
}
